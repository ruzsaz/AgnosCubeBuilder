...
public class DBConector {
        ...
        private static final org.slf4j.Logger logger = LoggerFactory.getLogger(DBConector.class);
    ...
    public static boolean executeQuery(String sql, String user, String password, String url, String driver) throws ClassNotFoundException, SQLException {
        boolean result = true;
